...
import infomations.Customer;
import infomations.InsuranceCard;
...
public class ProgramManager {
    ...
    public ArrayList<InsuranceCard> readInsuranceCards() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("src\\InsuranceCards.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String policyAwner = br.readLine();

                InsuranceCard insuranceCard = new InsuranceCard(parts[0], parts[1], policyAwner, anExpirationDate);
    ...
    public void addClaim() {
        ...
        System.out.println("Enter new claim information:");
        String id;
        while (true) {
            System.out.print("ID: ");
            id = scanner.nextLine();
        ...
        while (true) {
            ...
            System.out.println("InsuranceCard ID does not exist whith Customer ID, please re-enter!");
        }
